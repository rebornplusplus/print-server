"""
Django settings for printserver project.
...
SECRET_KEY = "django-insecure-3ssr^p*+p7iu^)ye1+p5kh4k%3u!vobnhjt(^796w=ril8_avj"
...
# The URL or named URL pattern where requests are redirected for login when using
